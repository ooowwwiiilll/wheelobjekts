    ...
    <div className="container">
      ...
      <div className="grid">
        ...
        <div className="column">
          <div className="product"><div data-id="1"><img src="/public/img-1.png" alt="" /></div></div>
          <div className="product"><div data-id="6"><img src="/public/img-6.png" alt="" /></div></div>
          <div className="product"><div data-id="3"><img src="/public/img-3.png" alt="" /></div></div>
          <div className="product"><div data-id="8"><img src="/public/img-8.png" alt="" /></div></div>
          <div className="product"><div data-id="5"><img src="/public/img-5.png" alt="" /></div></div>
        </div>

        {/* Column 9 (was 2) */}
        <div className="column">
          <div className="product"><div data-id="9"><img src="/public/img-9.png" alt="" /></div></div>
          <div className="product"><div data-id="2"><img src="/public/img-2.png" alt="" /></div></div>
          <div className="product"><div data-id="8"><img src="/public/img-8.png" alt="" /></div></div>
          <div className="product"><div data-id="3"><img src="/public/img-3.png" alt="" /></div></div>
          <div className="product"><div data-id="7"><img src="/public/img-7.png" alt="" /></div></div>
        </div>
        ...
        <div className="column">
          ...
          <div className="product"><div data-id="8"><img src="/public/img-8.png" alt="" /></div></div>
          <div className="product"><div data-id="5"><img src="/public/img-5.png" alt="" /></div></div>
          <div className="product"><div data-id="10"><img src="/public/img-10.png" alt="" /></div></div>
          <div className="product"><div data-id="1"><img src="/public/img-1.png" alt="" /></div></div>
        </div>

        {/* Column 4 */}
        <div className="column">
          <div className="product"><div data-id="4"><img src="/public/img-4.png" alt="" /></div></div>
          <div className="product"><div data-id="9"><img src="/public/img-9.png" alt="" /></div></div>
          <div className="product"><div data-id="2"><img src="/public/img-2.png" alt="" /></div></div>
          <div className="product"><div data-id="7"><img src="/public/img-7.png" alt="" /></div></div>
          <div className="product"><div data-id="6"><img src="/public/img-6.png" alt="" /></div></div>
      ...
      <div className="details">
        ...
        <div className="details__body">
          ...
          <img class="detail__img" src="/public/img-2.png" alt="" />
          <img class="detail__img" src="/public/img-1.png" alt="" />
          <img class="detail__img" src="/public/img-4.png" alt="" />
          <img class="detail__img" src="/public/img-3.png" alt="" />
        </div>
      </div>
