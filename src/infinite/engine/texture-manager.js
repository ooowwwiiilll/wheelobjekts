...
// Animated-GIF support now lives in a shared lib (used by /infinite + /verse).
// Re-exported here so existing engine imports keep working.
export { getGifTexture, tickGifs } from "../../lib/gif-texture.js";
