// Tunables for the infinite-canvas fly-through. JS port of the reference.
// NOTE: defined locally (not imported from utils.js) to avoid a circular
// import — utils.js imports CHUNK_SIZE from here.
const run = (fn) => fn();
